...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="evler.aspx.cs" Inherits="Emlak_Sitesi.evler" %>
<!DOCTYPE html>
...
<header class="header-area"><!--Header baslama alani -->
      ...
      <div class="south-search-area">
          <div class="container">
              <div>
                   <div>
                         <div class="advanced-search-form s_main">
                            ...
                            <p>EVLERDE ARA</p>
                             ...
                             <form action="#" method="post" id="advanceSearch">
                                 <div class="s_container">
                                     ...
                                     <div class = "s_objeccts">
                                         <div>
                                             <asp:TextBox ID="tbanahtar" CssClass="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                                         </div>
                                     </div>

                                     <div class = "s_objeccts">
                                          <div class="form-group">
                                              <asp:DropDownList ID="ddsehirler" CssClass="form-control"  runat="server"></asp:DropDownList>
                                          </div>
                                      </div>
                                     ...
                                     <div class = "s_objeccts">
                                         <div class="form-group">
                                             <asp:DropDownList ID="ddkategoriler" CssClass="form-control" runat="server"></asp:DropDownList>
                                         </div>
                                     </div>
                                     ...
                                     <div class = "s_objeccts">
                                         <div class="form-group">
                                        <asp:DropDownList ID="ddsatilik" runat="server" CssClass="form-control" ></asp:DropDownList>
                                         </div>
                                     </div>
                                      ...
                                      <div class = "s_objeccts">
                                         <div class="form-group">
                                             O.S.
                                             <asp:DropDownList ID="ddodasayisi" runat="server" CssClass="form-control" ></asp:DropDownList>
                                         </div>
                                    </div>
                                     ...
                                     <div class = "s_objeccts">
                                         <div class="form-group">
                                             S.S.
                                             <asp:DropDownList ID="ddoturmaodasi" runat="server" CssClass="form-control" ></asp:DropDownList>
                                         </div>
                                    </div>

   
                                    <div class = "s_arabtnFam">
                                        <asp:Button ID="btnara" class="btn south-btn s_arabtn" runat="server" Text="ARA" OnClick="btnara_Click" />
                                    </div>
