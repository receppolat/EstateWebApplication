<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sayfa.aspx.cs" Inherits="Emlak_Sitesi.sayfa" %>
...
<body>
    <form id="form1" runat="server">
                            ...
                            <div class="classynav">
                               ...
                               <%Response.Write(menuler); %>
                                <asp:LinkButton ID="giris" runat="server" OnClick="giris_Click">Giriş Yap</asp:LinkButton>
                                  <asp:LinkButton ID="kayit" runat="server" OnClick="kayit_Click">Çıkış Yap</asp:LinkButton>
                             </div>
                       </div>
                    </nav>
                </div>
      ...
      &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  <asp:Label ID="Label1" runat="server" Text="Label" Font-Size="XX-Large"></asp:Label>
